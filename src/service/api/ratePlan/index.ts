...
import { creataRatePlant, deleteRatePlant, getRatePlanList, updateRatePlant } from "./ratePlan.api"
...
const useRatePlantApi = (autoLoad: boolean=false)=>{
    ...
    const onUpdateRatePlantItem = async (ratePlantUpdate: RatePlantUpdate,id:number) => {
        on()
        try{
